  ...
  return (
    <div className="p-6 max-w-lg">
      ...
      <section className="mb-8">
        <h2 className="text-sm font-medium text-zinc-400 mb-3">Telegram account</h2>
        <div className="bg-zinc-900 rounded-lg p-4 text-sm ring-1 ring-white/[0.06]">
          <span className="text-zinc-300">@{user?.telegramUsername ?? '—'}</span>
        </div>
      </section>

      <section className="mb-8">
        <h2 className="text-sm font-medium text-zinc-400 mb-3">Base currency</h2>
